...
#############################################
setwd("C:/Users/ohagg/OneDrive - University College London/Desktop/Github/Country_coverage") # please set path to your working directory
...
var_url <- c("E120N60/E120N60", "E120N40/E120N40", "E140N60/E140N60", "E140N40/E140N40")
...
library(magick)
# load map
map1 <- magick::image_read("take_4.png")
...
map3 <- magick::image_annotate(
    ...
    location = "+1200+800", weight = 600
)

# caption 1 - author
map4 <- magick::image_annotate(
    map3, "©2023 Oliver Hagger (www.oliverhagger.com)",
    font = "Georgia",
